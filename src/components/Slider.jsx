...
import backgroundLine from '../assets/S8ulAssets/Background lines.png';
...
const EsportsCard = () => {
  ...
  return (
    <div className="esport-section my-custom-slider">
      <div className="my-custom-swiper-container">
        <Swiper
          ...
          onSlideChange={(swiper) => {
            ...
            document.querySelectorAll('.my-custom-swiper-slide').forEach(slide => {
              slide.classList.remove('my-custom-swiper-slide-active');
            });
            
            if (swiper.slides[swiper.activeIndex]) {
              swiper.slides[swiper.activeIndex].classList.add('my-custom-swiper-slide-active');
            }
          }}
          onInit={(swiper) => {
        ...
        >
          {images.map((src, index) => (
            <SwiperSlide 
              key={index} 
              className={`my-custom-swiper-slide my-custom-swiper-slide--${(index % 6) + 1}`}
            >
