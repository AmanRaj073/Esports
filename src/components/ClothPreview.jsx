    ...
    <>
      <div className="bg-black cloth preview-box pt-5">
        <div className="container">
          <div className="row align-items-stretch g-0" style={{border: "1px solid #333",}}>
              ...
              >
                <div>
                  ...
                  <div>
                    ...
                    {/* Selection Circles for Desktop and Tablets */}
                    <div className="mt-5 d-none d-md-flex gap-2 flex-wrap justify-content-start">
                      {jerseys.map((jersey) => (
                        <div
                          key={jersey.id}
                          ...
                          style={{
                            ...
                            overflow: "hidden",
                            cursor: "pointer",
                            border: selectedJersey.id === jersey.id ? "3px solid #ccff00" : "3px solid #333",
                            padding: "2px",
                        ...
                        >
                          <img
                            ...
                            style={{
                              ...
                              objectFit: "cover",
                              borderRadius: "50%",
                              filter: selectedJersey.id === jersey.id ? "none" : "brightness(0.7)",
            ...
            <div className="col-12 col-md-6 p-0 d-flex justify-content-center flex-column align-items-center">
              <div
                style={{
                  // border: "1px solid #333",
                  width: "100%",
              ...
              {/* Selection Circles for Mobile */}
              <div className="my-4 d-md-none d-flex gap-2 justify-content-center">
                {jerseys.map((jersey) => (
                  <div
                    key={jersey.id}
                    onClick={() => setSelectedJersey(jersey)}
